...
const memoryPairs = [
  ...
  { id: 1, text: 'Muestra datos en la consola.', type: 'def' },
  { id: 2, text: 'input()', type: 'concept' },
  { id: 2, text: 'Captura datos ingresados por usuario.', type: 'def' },
  { id: 3, text: 'int()', type: 'concept' },
  { id: 3, text: 'Convierte un valor a entero.', type: 'def' },
  { id: 5, text: 'len()', type: 'concept' },
  { id: 5, text: 'Retorna cantidad de elementos.', type: 'def' },
  { id: 6, text: 'if / else', type: 'concept' },
  { id: 6, text: 'Estructura de control condicional.', type: 'def' },
  { id: 7, text: 'while', type: 'concept' },
  { id: 7, text: 'Bucle condicional (mientras).', type: 'def' },
  { id: 8, text: 'for', type: 'concept' },
  { id: 8, text: 'Bucle que recorre secuencia.', type: 'def' },
  { id: 9, text: 'list.append()', type: 'concept' },
  { id: 9, text: 'Agrega elemento al final de lista.', type: 'def' },
  { id: 11, text: 'def', type: 'concept' },
  { id: 11, text: 'Palabra para declarar función.', type: 'def' },
  { id: 13, text: 'import pandas', type: 'concept' },
  { id: 13, text: 'Importa la librería Pandas.', type: 'def' },
  { id: 14, text: 'pd.read_csv()', type: 'concept' },
  { id: 14, text: 'Carga un archivo CSV.', type: 'def' },
  { id: 15, text: 'df.head()', type: 'concept' },
  { id: 15, text: 'Muestra primeras 5 filas.', type: 'def' },
  { id: 16, text: 'df.describe()', type: 'concept' },
  { id: 16, text: 'Genera estadísticas descriptivas.', type: 'def' },
  { id: 18, text: 'DataFrame', type: 'concept' },
  { id: 18, text: 'Estructura de datos (tabla).', type: 'def' },
  { id: 19, text: 'df.iloc[]', type: 'concept' },
  { id: 19, text: 'Accede por posición entera.', type: 'def' },
  { id: 21, text: 'df.dropna()', type: 'concept' },
  { id: 21, text: 'Elimina filas con valores nulos.', type: 'def' },
  { id: 23, text: 'df.groupby()', type: 'concept' },
  { id: 23, text: 'Agrupa datos por columnas.', type: 'def' },
  { id: 24, text: 'df.sort_values()', type: 'concept' },
  { id: 24, text: 'Ordena datos según columna.', type: 'def' }
];
